      ...
      {loading ? (
        ...
        topics.map((t) => (
          <button
            ...
            className="px-4 py-2 rounded-full border border-emerald-600/20 bg-emerald-700/20 hover:bg-emerald-700/30 text-sm shrink-0 transition text-white" //This sets the color for the individual topics bubbles
